...
class ConsumablesGame(Game):
    ...
    def consumables(self) -> list[Consumable]:
        ...
        consumables: list[Consumable] = [
            ...
            Consumable(
                ...
                description="Complete 1 accessible trial from anywhere.",
                rarity=ConsumableRarity.rare,
            ...
            Consumable(
                ...
                description="Complete up to 2 accessible trials from anywhere.",
                rarity=ConsumableRarity.very_rare,
                types=["chosen_trial", "any_areas"],
                conditionals=[
                    ConsumableConditional(
    ...
    def optional_game_constraint_templates(self) -> list[GameObjectiveTemplate]:
        return [
            GameObjectiveTemplate(
                label="Consumables completed by other consumables have no effect",
                data={},
            )
        ]
