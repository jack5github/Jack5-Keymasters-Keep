...
class AsphaltLegendsGame(Game):
    ...
    def bonus_objectives() -> list[str]:
        return [
            ...
            "Crash after winning a race",
            "Crash due to rotating onto your side while riding the walls of a track",
            ...
            "Place 3rd or better in a multiplayer race (or win a team race)",
            ...
            "Perform 5 barrel rolls in a row",
