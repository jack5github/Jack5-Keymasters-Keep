...
class TriviaTricksGame(Game):
    ...
    def bonus_objectives() -> list[str]:
        return [
            ...
            "Change your answer at time remaining 1 or 0, and end up with the correct answer",
            "Change your answer at time remaining 1 or 0, from the correct one to a wrong one",
